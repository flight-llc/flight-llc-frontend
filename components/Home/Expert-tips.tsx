...
export const ExpertTips = () => {
    return (
        <div id="bg-expert" className="my-8 flex justify-center">
            <div className="lg:w-4/5 xl:w-[70%] py-20">
                <p className="text-start text-[#6E7491] uppercase px-4 text-lg font-semibold">EXPERT TIPS FOR YOUR NEXT ADVENTURE </p>
                ...
                <div className="w-full flex justify-between my-8 items-center">
                    ...
                    <div className="basis-2/5 text-[#6E7491] text-sm text-center">

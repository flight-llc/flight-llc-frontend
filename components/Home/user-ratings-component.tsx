...
export const UserExperienceRatings: FC<props> = ({ comments, average }) => {
  return (
    ...
    <div id="bg-cloud" className="w-full p-4 flex justify-center items-center">
      <div className="w-4/5 h-auto">
        <p id='review-text-size' className="text-xl font-semibold text-[#2C53B8] text-center pb-4">
